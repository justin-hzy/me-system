package com.me.modules.mabang.refund.service.impl;
...
import com.me.modules.mabang.refund.mapper.MBRefundMapper;
...
@Service
@Slf4j
public class MBRefundServiceImpl extends ServiceImpl<MBRefundMapper, MBRefund> implements MBRefundService {

    @Override
    public void insertMBRefund(InsertMBRefundDto dto) {

        CloseableHttpResponse response;// 响应类,
        CloseableHttpClient httpClient = HttpClients.createDefault();

        //restful接口url
        HttpPost httpPost = new HttpPost("http://39.108.136.182:8080/api/cube/restful/interface/saveOrUpdateModeData/ModeDataService_157");
        //当前日期
        ...
        mainTable.put("refund_time", dto.getRefundTime());
        ...
        mainTable.put("status", Integer.valueOf(status)-1);
        ...
        List<InsertMBRefundDtl> dtls = dto.getInsertMBRefundDtls();
        for (InsertMBRefundDtl dtl : dtls){
            JSONObject dataJson = new JSONObject();
            dataJson.put("stock_sku",dtl.getStockSku());
            dataJson.put("quantity1",dtl.getQuantity1());
            dataJson.put("sell_price",dtl.getSellPrice());
