...
public class DmsTest {
    ...
    public void doAction(){
        ...
        //restful接口url
        HttpPost httpPost = new HttpPost("http://39.108.136.182:8080/api/cube/restful/interface/saveOrUpdateModeData/ModeDataService_156");
        //当前日期
        ...
        mainTable.put("platform_order_id", "123");
        mainTable.put("express_time", "2024-01-01");
        mainTable.put("street", "明丰大夏");
        mainTable.put("shop_id", "123456");
        mainTable.put("currency_id", "pre005");
        ...
        dataJson.put("stock_sku","6937467643843");
        dataJson.put("quantity",100);
        dataJson.put("sell_price",10.5);
