...
public class SearchHttpAK {
    ...
    public static String URL = "https://api.map.baidu.com/address_analyzer/v1?";

    public static String AK = "UAcYLT55h5rf74q06DSNtpd8PB9wMqyg";
    ...
    public static void main(String[] args) throws Exception {
        ...
        params.put("address", "北京市海淀区信息路甲九号");
        params.put("ak", AK);
