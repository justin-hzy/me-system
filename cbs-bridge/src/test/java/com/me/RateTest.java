...
public class RateTest {
     ...
     */
    //static final String token = "5934673c-b7dd-4307-85e4-4e32796f1921";//chongxin
...
//        HttpPost httpPost = setupRequest(requestData,token);
//
...
//            client.close();
//        }
        rateService.queryRate();
    }

    private static HttpPost setupRequest(String requestData,String token) {
