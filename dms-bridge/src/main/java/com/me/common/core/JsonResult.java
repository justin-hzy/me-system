...
public class JsonResult<T> {
    ...
    /**
     * 返回成功：自定义成功码，带成功信息，业务数据(少数情况使用)
     *
     * @param <T> 数据类型
     * @return 数据类型
     */
    public static <T> JsonResult<T> ok(String code, String message, T data) {
    ...
    public static <T> JsonResult<T> error() {
        return new JsonResult<>(ResultCode.UNKNOWEXCEPTION.getCode(), ResultCode.UNKNOWEXCEPTION.getMessage());
    }
